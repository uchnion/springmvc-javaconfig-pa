<%-- 
    Document   : tambahmapel
    Created on : May 19, 2014, 5:51:36 PM
    Author     : Marojahan
--%>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="span9">
                    ...
                    <h3 style="text-align:center">FORM TAMBAH MATA PELAJARAN</h3>

                    <form:form commandName="tbmapel" action="${pageContext.request.contextPath}/mapelinput" method="POST"
