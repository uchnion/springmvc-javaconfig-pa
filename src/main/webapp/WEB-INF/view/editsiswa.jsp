        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="span9">
                    ...
                    <form:form commandName="ubahsiswa" action="${pageContext.request.contextPath}/siswaedit/${ubahsiswa.id}"
                        ...
                        <div class="controls">
                            <p><input type="submit" class="btn btn-primary" value="Simpan Perubahan">
                                <a href="${pageContext.request.contextPath}/mapeltampil" class="btn">Batal</a></p>
                        </div>
                    </form:form>
