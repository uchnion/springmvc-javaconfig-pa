        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="span9">
                    ...
                    <form:form commandName="addmplsis" class="bs-docs-example form-horizontal" 
                               action="${pageContext.request.contextPath}/mplsis/input" method="POST">
                        ...
                        <div class="control-group info">
                            ...
                            <div class="controls">
                                <form:select class="span2" path="mapel.mapelId" items="${listmapel}"/>
                            </div>
                        </div>
